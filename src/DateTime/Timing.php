...
class Timing
{
	 ...
	 * @return string
     */
	public static function timezoneSelector($selected = null, $placeholder = null, array $selectAttributes = [], array $optionAttributes = [] )
	{
		if (empty($selectAttributes['name'])) {
			$selectAttributes['name'] = 'timezone';
		}

		if (empty($selectAttributes['id'])) {
			$selectAttributes['id'] = 'timezone';
		}
	...
	{
		$dateTime = new \Carbon\Carbon($timestamp, 'UTC');
    ...
    {
		$dateTime = new \Carbon\Carbon($timestamp, $timezone);
